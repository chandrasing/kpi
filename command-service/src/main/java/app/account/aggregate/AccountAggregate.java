...
import app.account.commands.CloseAccountCommand;
import app.account.commands.CreateAccountCommand;
import app.account.commands.DepositMoneyCommand;
import app.account.commands.WithdrawMoneyCommand;
...
public class AccountAggregate implements Serializable {
    ...
    public AccountAggregate(CreateAccountCommand command) {
        ...
        Assert.hasLength(creator, "Missing commands creator");
